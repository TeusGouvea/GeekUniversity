...
public class Programa82 {
    ...
    public static void main(String[] args) {
        ...
        LocalDate ano_novo = LocalDate.of(2026, Month.JANUARY, 1);
        ...
        DateTimeFormatter formatorHoras = DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss");
        System.out.println(agora.format(formatorHoras));

        LocalTime intervalo = LocalTime.of(10, 30, 0);
